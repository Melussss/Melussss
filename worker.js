...
function card(p) {
  const cat = categories.find((c) => c.slug === p.category), showBadge = p.badge && p.badge.toLowerCase() !== p.condition.toLowerCase();
